...
import { exploreSlogan, homeSlogan, jewellerySubTitle, jewelleryTitle, mobileNumber } from '../Config/Static_data';
                    ...
                    ExplorePage ?
                        ...
                        <>
                            ...
                            <div className="btn-container">
                                ...
                                <button onClick={() => { window.open(`https://wa.me/${mobileNumber}`, "_blank"); }} className="learnmore secondary">
                                    Contact <ion-icon name="logo-whatsapp"></ion-icon>
                                </button>
                            </div>
                        </>
                }
